  ...
  return (
    <div className="min-h-screen bg-transparent relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold text-white drop-shadow-md">Auctions</h1>
        ...
        <div className="mb-6 flex items-center gap-2">
          ...
          <p className="text-lg font-bold text-white drop-shadow-sm">
            {filter === "all" ? "All auctions" : filter.charAt(0).toUpperCase() + filter.slice(1)}
        ...
        {filteredAuctions.length === 0 ? (
          <div className="text-center py-20 glass-panel flex flex-col items-center">
            ...
            <p className="text-slate-400 text-lg">No auctions found in this category.</p>
          </div>
        ) : (
