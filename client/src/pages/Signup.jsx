    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-rose-500/20 to-orange-500/20 border border-rose-500/30 rounded-2xl mb-6 shadow-[0_0_20px_rgba(244,63,94,0.2)]">
            <svg
          ...
          <p className="text-slate-400 mt-2 text-lg">
            Join the premium auction community
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                minLength={8}
              />
              <p className="ml-1 text-xs text-slate-500 font-medium tracking-wide">
